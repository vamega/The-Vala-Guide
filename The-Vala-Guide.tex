...
\newcommand{\inputvalacodefile}[1]{\inputminted[linenos=true,bgcolor=bg,framesep=10pt,frame=lines,rulecolor=\color{bg}]{vala}{#1}}

\newenvironment{bashcommands}{\ttfamily\color[RGB]{22,22,22}}{}

%\newenvironment{bashcommands}{\backgroundbox}{}
%\def\backgroundbox#1\end{\colorbox{bg}{#1}\end}
